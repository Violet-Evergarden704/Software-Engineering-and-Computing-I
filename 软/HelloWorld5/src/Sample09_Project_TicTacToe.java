import oo.game.Result;

import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;

public class Sample09_Project_TicTacToe {
    ...
    public void play() {//throws oo.game.MyException{
    ...
    public static void main(String[] args){
        Sample09_Project_TicTacToe g = new Sample09_Project_TicTacToe();
        g.play();
    }
    public void init(){
